import { reactive, getCurrentInstance, effectScope, ref, markRaw, toRaw, inject, watch, unref, isRef, isReactive, toRef, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, version, defineAsyncComponent, shallowRef, isReadonly, h, defineComponent, Transition, Suspense, provide, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
const tailwind = "";
const bootstrapDatepicker_min = "";
const materialDesignIconicFont_min = "";
const style_min = "";
const main = "";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/ai_draw-83854b3a.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-f206e9bb.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/login-9922119c.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/register-bde34e58.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/reset-90b9384d.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/setting-21cf5799.js").then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-c0d413bc.js"),
  islogin: () => import("./_nuxt/islogin-aadafef7.js")
};
...
const layouts = {
  default: () => import("./_nuxt/default-c704890f.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-3c0bee56.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-e10177b0.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
